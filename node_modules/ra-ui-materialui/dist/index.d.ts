 ...
 */
declare const AutocompleteArrayInput: <OptionType extends RaRecord = RaRecord, DisableClearable extends boolean = boolean, SupportCreate extends boolean = false>({ defaultValue, ...props }: AutocompleteArrayInputProps<OptionType, DisableClearable, SupportCreate>) => JSX.Element;
