...
var DashboardMenuItem = function (props) {
    var locale = props.locale, _a = props.leftIcon, leftIcon = _a === void 0 ? react_1.default.createElement(Dashboard_1.default, null) : _a, rest = __rest(props, ["locale", "leftIcon"]);
    var translate = (0, ra_core_1.useTranslate)();
    var basename = (0, ra_core_1.useBasename)();
    return (react_1.default.createElement(MenuItemLink_1.MenuItemLink, __assign({ to: "".concat(basename, "/"), primaryText: translate('ra.page.dashboard'), leftIcon: leftIcon }, rest)));
};
